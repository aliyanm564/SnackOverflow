...
def get_my_reviews(
    ...
    return [_to_response(r) for r in svc.get_my_reviews(current_user)]
...
def get_review_for_order(
    ...
    review = svc.get_review_for_order(current_user, order_id)
    if review is None:
        raise HTTPException(
...
def get_restaurant_reviews(
    ...
    return [_to_response(r) for r in svc.get_restaurant_reviews(restaurant_id)]
