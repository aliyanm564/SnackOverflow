...
class ReviewService:
    ...
    def create_review(
        ...
        if requesting_user.role != UserRole.CUSTOMER:
            raise AuthorizationError("Only customers can submit reviews.")
        ...
        if order.customer_id != requesting_user.customer_id:
            raise AuthorizationError("You can only review your own orders.")
    ...
    def update_review(
        ...
        if review.customer_id != requesting_user.customer_id:
            raise AuthorizationError("You can only edit your own reviews.")
    ...
    def get_review_for_order(self, requesting_user: User, order_id: str) -> Optional[Review]:
        ...
        if order.customer_id != requesting_user.customer_id:
            raise AuthorizationError("You cannot access this order.")
